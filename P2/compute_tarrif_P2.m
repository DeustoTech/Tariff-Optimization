function [hourly_data,monthly_data] = compute_tarrif_P2(load_curve_csv,price_table_hourly,json_path)

json_fileID = fopen(json_path,'r');

p_P2 = jsondecode(fscanf(json_fileID,'%s'));
[maxPower,hourly_data] = compute_power_params_P2(load_curve_csv);
...
PPP2 = p_P2.PowerPrice(:)';
hourly_data.power_cost_by_kW = PPP2(hourly_data.tramo_power)';
...
p_P2.Potencia_de_contratacion_opt = maxPower;
FID = fopen('tariff_P2_output.json','w');
fwrite(FID,jsonencode(p_P2));
%
end
