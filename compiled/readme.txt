...
================================
-run_P2json.sh (shell script for temporarily setting environment variables and executing 
                the application)
   -to run the shell script, type
   
       ./run_P2json.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v910, run the shell script as:
       ...
       ./run_P2json.sh /mathworks/home/application/v910
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_P2json.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure P2json.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r P2json.zip P2json.app
    or the tar command 
    tar -cvf P2json.tar P2json.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v910/runtime/maci64:MR/v910/sys/os/maci64:MR/v910/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_P2json.sh 
